...
#_Fcast_years:  beg_selex, end_selex, beg_relF, end_relF  (enter actual year, or values of 0 or -integer to be rel. endyr)
 0 0 0 0
#  2008 2008 2008 2008 # after processing 
...
2059  #FirstYear for caps and allocations (should be after years with fixed inputs) 
